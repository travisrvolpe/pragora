...
// Export component types from Radix UI
...
interface SubTriggerProps extends DropdownMenuSubTriggerProps {
  inset?: boolean;
}
...
interface LabelProps extends DropdownMenuLabelProps {
  inset?: boolean;
}
...
interface CheckboxItemProps extends DropdownMenuCheckboxItemProps {
  checked?: boolean;
}

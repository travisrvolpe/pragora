...
const UserProfile: React.FC = () => {
  ...
  const InputField: React.FC<InputFieldProps> = ({label, name, value = '', type = "text", disabled = false
  }) => (
  ...
  // Rest of your JSX remains the same, just add proper type annotations where needed

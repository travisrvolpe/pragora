// applib/constants/constants.ts
import type { Category } from '@/types/posts/page-types';

//export const DEFAULT_AVATAR_URL = '/home/notsure/pragora/frontend/pragora-frontend/public/images/avatars/default-avatar.PNG';
export const DEFAULT_AVATAR_URL = '/images/avatars/default-avatar.png';
//export const DEFAULT_AVATAR_URL = '/images/avatars/ZERO_CROP.PNG';
export const API_BASE_URL = process.env.NEXT_PUBLIC_API_URL || 'http://localhost:8000';
export const TOKEN_KEY = 'access_token';

// Avatar related constants
export const AVATAR_UPLOAD_ENDPOINT = `${API_BASE_URL}/profiles/me/avatar`;

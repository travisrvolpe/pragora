...
const PostWrapper: React.FC<PostWrapperProps> = ({
  ...
  const handleLike = async () => {
    try {
      ...
      const response = await engagementService.like(post.post_id);
  ...
  const handleDislike = async () => {
    try {
      ...
      const response = await engagementService.dislike(post.post_id);
  ...
  const handleReport = async (reason: string) => {
    try {
      ...
      const response = await engagementService.report(post.post_id, reason);
